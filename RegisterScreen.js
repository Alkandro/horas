...
const RegisterScreen = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Guarda información adicional del usuario en Firestore (incluyendo el rol por defecto)
      ...
      navigation.navigate('UserHome'); // Redirige al usuario a la pantalla principal
    } catch (e) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button
        ...
        onPress={() => navigation.goBack()} // Regresa a la pantalla anterior (Login)
